                    ...
                    <table className="w-full">
                        <thead className="bg-slate-50 dark:bg-slate-900">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase">Fecha de Inicio</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase">Fecha de Fin</th>
