...
export default function PlayerHistory() {
 ...
 <span className="text-xl md:text-2xl">A</span>
 </div>
 ...
 <div className="text-xs font-semibold px-2 py-1 rounded bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-200">{player.isActive ? 'Activo' : 'Inactivo'}</div>
 <div>
 ...
 {history.movement === 'STAY' && 'Mantiene'}
 </span>
 </>
 )}
 </>
