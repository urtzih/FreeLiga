    ...
    return (
        <div className="space-y-6">
                    ...
                    <div className="p-6">
                        <div className="flex items-center justify-between mb-4">
                            <div>
                                ...
                                <p className="text-slate-600 dark:text-slate-400">{currentGroup.season.name}</p>
                            </div>
                            <div className="text-right">
                                <div className="text-4xl font-bold text-blue-600 dark:text-blue-400">
                                    #{myRanking?.rankingPosition || '-'}
                                </div>
                                <p className="text-sm text-slate-600 dark:text-slate-400">Tu Posición</p>
                            </div>
                        </div>
                        <Link
            ...
            {playerStats && playerStats.currentStreak !== 0 && (
                <div className={`rounded-2xl p-6 ${playerStats.currentStreak > 0
                    ? 'bg-gradient-to-r from-green-500 to-green-600'
                    : 'bg-gradient-to-r from-red-500 to-red-600'
                    } text-white shadow-lg`}>
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className="text-lg font-semibold mb-1">Racha Actual</h3>
