                ...
                <div className="flex gap-2">
                    ...
                    {group.whatsappUrl && (
                        <a
                            ...
                            className="px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors font-medium flex items-center gap-2 shadow-sm whitespace-nowrap"
